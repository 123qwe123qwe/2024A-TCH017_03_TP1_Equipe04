...
;         DESCRIPTION     :
;
;                  Ce projet montre comment transformer des nombres codés en 0 et 1 (format IEEE 754) 
;                  en nombres décimaux. Le programme vérifie si les données sont correctes,
;                  gère des cas spéciaux comme des nombres très petits, 
;                  et affiche les étapes pour mieux comprendre la conversion.             
